...
Vocksel::ComputeMesh::ComputeMesh() {
  ...
  glBufferData(GL_SHADER_STORAGE_BUFFER, MAX_VERTICES * sizeof(Vertex), nullptr,
               GL_DYNAMIC_COPY);
...
void Vocksel::ComputeMesh::bind() { glBindVertexArray(VAO_); }

void Vocksel::ComputeMesh::unbind() { glBindVertexArray(0); }

...
Vocksel::Texture::Texture(const char* path) { loadTexture(path); }
...
void Vocksel::Texture::bind() { glBindTexture(GL_TEXTURE_2D, texture_id_); }

void Vocksel::Texture::unbind() { glBindTexture(GL_TEXTURE_2D, 0); }
...
Vocksel::Texture::~Texture() { cleanUp(); }

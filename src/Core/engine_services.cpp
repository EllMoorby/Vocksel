...
std::unique_ptr<Vocksel::ResourceManager>
    Vocksel::EngineServices::resource_manager_;
std::unique_ptr<Vocksel::InputManager> Vocksel::EngineServices::input_manager_;
std::unique_ptr<Vocksel::DebugRenderer>
    Vocksel::EngineServices::debug_renderer_;
...
Vocksel::EngineServices::~EngineServices() { cleanUp(); }
